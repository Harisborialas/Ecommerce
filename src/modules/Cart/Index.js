...
const Cart = () => {
  ...
  if(carts.length === 0){ return (<div className="flex justify-center items-center font-bold text-4xl h-[55vh]" >Cart Is Empty</div>)}
      ...
      <div className="flex shadow-md my-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="flex justify-between mt-10 mb-5">
            ...
            <span className="font-semibold text-sm">{total.toFixed()}$</span>
          </div>
          <div>
